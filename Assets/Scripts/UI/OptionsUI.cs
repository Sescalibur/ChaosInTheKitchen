...
public class OptionsUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI pasuseText;
    ...
    {
        soundEffectsText.text = "Sound Effcts : " + Mathf.Round(SoundManager.Instance.GetVolume()*10);
        ...
        pasuseText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Pause);
    }
